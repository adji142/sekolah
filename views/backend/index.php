		...
		<div class="modal" id="cms-info">
							...
							<table class="table table-condensed table-bordered">
								<tbody>
									...
									<tr>
										<td>Author</td>
										<td>:</td>
										<td><a href="https://www.facebook.com/satriadirgantara">Satria Dirgantara</a></td>
									</tr>
									<tr>
										<td>Email</td>
										<td>:</td>
									...
									<tr>
										<td>Link</td>
										<td>:</td>
										<td><a href="<?=config_item('website')?>">koyor.id</a></td>
									</tr>
									<tr>
										<td>Copyright</td>
										<td>:</td>
			...
			<footer class="main-footer">
				<div class="pull-right hidden-xs">
					<p>Powered by <a href="<?=$this->config->item('website');?>" target="_blank"><?=$this->config->item('webmaster');?></a></p>
				</div>
