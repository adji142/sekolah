    ...
    */
	...
	public function index() {
      ...
      // Gelombang Pendaftaran
		$phase = $this->CI->m_admission_phases->get_current_phase();
		if (count($phase) > 0) {
			$session_data['admission_phase_id'] = $phase['id'];
			$session_data['admission_phase'] = $phase['phase_name'];
			$session_data['admission_start_date'] = $phase['phase_start_date'];
			$session_data['admission_end_date'] = $phase['phase_end_date'];
		}
