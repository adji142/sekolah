...
class Videosp extends Admin_Controller {
	...
	public function __construct() {
		parent::__construct();
		$this->load->model('m_videosp');
		$this->pk = M_videosp::$pk;
		$this->table = M_videosp::$table;
	}
	...
	public function index() {
		...
		$this->vars['blog'] = $this->vars['videosp'] = true;
		$this->vars['content'] = 'blog/videosp';
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_videosp->get_where($keyword, 'rows', $limit, $offset);
			$total_rows = $this->m_videosp->get_where($keyword);
